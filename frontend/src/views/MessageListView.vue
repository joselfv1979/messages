...
<template>
  <div>
    ...
    <div v-else-if="store.messages.length === 0" class="text-center py-20 bg-white/90 dark:bg-navy-800/90 backdrop-blur-sm rounded-2xl border border-dashed border-navy-300 dark:border-navy-700">
    ...
    <div v-else class="grid gap-4">
      <div
        ...
        :key="message.id"
        class="bg-white/90 dark:bg-navy-800/90 backdrop-blur-sm rounded-xl border border-navy-200 dark:border-navy-700 p-6 hover:shadow-lg hover:shadow-navy-100/30 dark:hover:shadow-black/20 transition-all duration-200"
      >
